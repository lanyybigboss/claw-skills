...
# Backup Skill Script
# Supports Google Drive optimized backup
...
source "$HOME/.openclaw/workspace/skills/backup-skill/scripts/google-drive-backup.sh"
...
show_options() {
    ...
    echo ""
    echo "3. Google Drive Backup"
    echo "   backup-skill google-drive optimized"
    echo "   backup-skill google-drive selective"
    echo ""
    echo "4. Backup Info"
    echo "   backup-skill info"
    echo ""
    echo "5. Clean Old Backups"
    echo "   backup-skill google-drive clean"
    echo ""
...
main() {
    ...
    case "$command" in
        ...
        *)
            ...
            echo "  google-drive - Google Drive optimized backup"
            echo ""
            echo "Google Drive subcommands:"
            echo "  backup-skill google-drive optimized"
            echo "  backup-skill google-drive selective"
            echo "  backup-skill google-drive clean"
            echo "  backup-skill google-drive options"
            ;;
    esac
}
